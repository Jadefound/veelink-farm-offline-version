...
import { FileText, Download, Filter, ChevronDown, Calendar, ArrowUpDown, ArrowLeft, FileBarChart } from "lucide-react-native";
            ...
            <View style={styles.bannerContainer}>
              ...
              >
                <View style={styles.bannerContent}>
                  <FileBarChart size={40} color="#fff" style={styles.bannerIcon} />
                  <View style={styles.bannerTextContainer}>
                    <Text style={styles.bannerTitle}>Data Reports</Text>
                    <Text style={styles.bannerSubtitle}>
                      Generate and export detailed reports in PDF format
                    </Text>
                  </View>
                </View>
              </LinearGradient>
